		...
		<div id="centrar">
			<table cellpadding="5" cellspacing="5" rules="all" border-bottom="3" bordercolor="#23ACF0">
				...
				<c:forEach var="comprados" items="${ sessionScope.comprados }">
					<form
						action="http://localhost:8080/practica6/vaciarCarrito?idproducto=${prod.id}" method="post">
						<tr>
							...
							<div align="left" width="350px" min-height="100px">Cantidad: <c:out value="${comprados.cantidad}" /></div>
							</td>
